...
|---|---------|----------|----------------|
| 1 | Push notifications | High | app.js, notifications.html |
...
| 3 | All modules | Map placeholders need real map integration (Google Maps / Leaflet) |
| 4 | `login.html` | Social login buttons (Google/Microsoft) are visual only |
...
**Total pending items: 32** (20 resolved)
